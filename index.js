...
let phoneNumber = "233209033293"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "T3RROR v1͎"
global.themeemoji = "•"
...
\n\n T3RROR XMD is Connected Successfully!
\n\n⏰ Time: ${new Date().toLocaleString()}\n
✅ Status: Online and Ready!
\n✅Make sure to join below channel
:https://whatsapp.com/channel/0029VbB4AeoF1YlZVNDXUe2v
 
             
JOIN SHADOW ETHIX FOR UPDATES🤩  
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || ' T3RROR MD͎'} ]`)}\n\n`))
            ...
            console.log(chalk.green(`${global.themeemoji || '•'} T3RROR MD is Connected Successfully! ✅`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
